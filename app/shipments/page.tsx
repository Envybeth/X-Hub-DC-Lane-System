  ...
  try {
    ...
    pts?.forEach(pt => {
      ...
      groupedShipments[key].pts.push({
        ...
        start_date: pt.start_date, // ADD THIS
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold">Outbound Shipments</h1>
            <p className="text-gray-400 mt-2">Manage pickup staging and consolidation</p>
          </div>
